...
| partial_open_10_percentage   | int         | No       | `10`                                          | Set the `Partially opened (10%)` button to custom a percentage (0-100).                                                                                                                                                                                                    |
| partial_open_25_percentage   | int         | No       | `25`                                          | Set the `Partially opened (25%)` button to custom a percentage (0-100).                                                                                                                                                                                                    |
| partial_open_50_percentage   | int         | No       | `50`                                          | Set the `Partially opened (50%)` button to custom a percentage (0-100).                                                                                                                                                                                                    |
| partial_open_75_percentage   | int         | No       | `75`                                          | Set the `Partially opened (75%)` button to custom a percentage (0-100).                                                                                                                                                                                                    |
...
| partial_open_10_percentage   | int         | No       | global item setting, see under _General_ | see under _General_                                                                         |
| partial_open_25_percentage   | int         | No       | global item setting, see under _General_ | see under _General_                                                                         |
| partial_open_50_percentage   | int         | No       | global item setting, see under _General_ | see under _General_                                                                         |
| partial_open_75_percentage   | int         | No       | global item setting, see under _General_ | see under _General_                                                                         |
